...
// THIS FILE WILL BE DELETED AFTER GQLGEN CONFIG CHANGES ARE FINISHED
import (
	"context"
	"fmt"
	"net/http"
	...
	gqlUtil "github.com/evergreen-ci/evergreen/graphql/resolvers/util"
...
func (r *Resolver) Patch() generated.PatchResolver {
...
func (r *Resolver) Volume() generated.VolumeResolver {
	return &volumeResolver{r}
}
func (r *Resolver) TaskQueueItem() generated.TaskQueueItemResolver {
...
func (r *Resolver) RepoRef() generated.RepoRefResolver {
	return &repoRefResolver{r}
}

func (r *Resolver) Annotation() generated.AnnotationResolver {
	return &annotationResolver{r}
}

func (r *Resolver) TaskLogs() generated.TaskLogsResolver {
...
func (r *Resolver) RepoSettings() generated.RepoSettingsResolver {
...
func (r *Resolver) Permissions() generated.PermissionsResolver {
	return &permissionsResolver{r}
}

// IssueLink returns IssueLinkResolver implementation.
func (r *Resolver) IssueLink() generated.IssueLinkResolver {
	return &issueLinkResolver{r}
}

func (r *Resolver) ProjectVars() generated.ProjectVarsResolver {
...
func (r *queryResolver) MyPublicKeys(ctx context.Context) ([]*restModel.APIPubKey, error) {
	publicKeys := gqlUtil.GetMyPublicKeys(ctx)
...
func (r *taskResolver) AbortInfo(ctx context.Context, at *restModel.APITask) (*gqlModel.AbortInfo, error) {
	if !at.Aborted {
		return nil, nil
	}
	...
	if len(at.AbortInfo.TaskID) > 0 {
		...
		if err != nil {
			return nil, gqlError.InternalServerError.Send(ctx, fmt.Sprintf("Problem getting aborted task %s: %s", *at.Id, err.Error()))
		}
		if abortedTask == nil {
			return nil, gqlError.ResourceNotFound.Send(ctx, fmt.Sprintf("Unable to find aborted task %s: %s", at.AbortInfo.TaskID, err.Error()))
		}
...
func (r *taskResolver) DependsOn(ctx context.Context, at *restModel.APITask) ([]*gqlModel.Dependency, error) {
	...
	if err != nil {
		return nil, gqlError.InternalServerError.Send(ctx, fmt.Sprintf("Cannot find dependency tasks for task %s: %s", *at.Id, err.Error()))
	}
	...
	i, err := at.ToService()
	if err != nil {
		return nil, gqlError.InternalServerError.Send(ctx, fmt.Sprintf("Error getting service model for APITask %s: %s", *at.Id, err.Error()))
	}
	t, ok := i.(*task.Task)
	if !ok {
		return nil, gqlError.InternalServerError.Send(ctx, fmt.Sprintf("Unable to convert APITask %s to Task", *at.Id))
	}
...
func (r *taskResolver) CanOverrideDependencies(ctx context.Context, at *restModel.APITask) (bool, error) {
	currentUser := gqlUtil.MustHaveUser(ctx)
...
func (r *permissionsResolver) CanCreateProject(ctx context.Context, permissions *gqlModel.Permissions) (bool, error) {
...
func (r *projectResolver) IsFavorite(ctx context.Context, at *restModel.APIProjectRef) (bool, error) {
	...
	if err != nil || p == nil {
		return false, gqlError.ResourceNotFound.Send(ctx, fmt.Sprintf("Could not find project: %s : %s", *at.Identifier, err))
	}
	usr := gqlUtil.MustHaveUser(ctx)
...
func (r *projectSettingsResolver) Vars(ctx context.Context, obj *restModel.APIProjectSettings) (*restModel.APIProjectVars, error) {
	return gqlUtil.GetRedactedAPIVarsForProject(ctx, utility.FromStringPtr(obj.ProjectRef.Id))
}
...
func (r *projectSettingsResolver) Aliases(ctx context.Context, obj *restModel.APIProjectSettings) ([]*restModel.APIProjectAlias, error) {
	return gqlUtil.GetAPIAliasesForProject(ctx, utility.FromStringPtr(obj.ProjectRef.Id))
}
func (r *projectSettingsResolver) Subscriptions(ctx context.Context, obj *restModel.APIProjectSettings) ([]*restModel.APISubscription, error) {
	return gqlUtil.GetAPISubscriptionsForProject(ctx, utility.FromStringPtr(obj.ProjectRef.Id))
}
...
func (r *mutationResolver) SpawnVolume(ctx context.Context, spawnVolumeInput gqlModel.SpawnVolumeInput) (bool, error) {
	err := gqlUtil.ValidateVolumeExpirationInput(ctx, spawnVolumeInput.Expiration, spawnVolumeInput.NoExpiration)
	if err != nil {
		return false, err
	}
	volumeRequest := host.Volume{
		...
		CreatedBy:        gqlUtil.MustHaveUser(ctx).Id,
	}
	vol, statusCode, err := cloud.RequestNewVolume(ctx, volumeRequest)
	if err != nil {
		return false, gqlUtil.MapHTTPStatusToGqlError(ctx, statusCode, err)
	}
	if vol == nil {
	...
	err = gqlUtil.ApplyVolumeOptions(ctx, *vol, additionalOptions)
	if err != nil {
	...
	if spawnVolumeInput.Host != nil {
		...
		if err != nil {
			return false, gqlUtil.MapHTTPStatusToGqlError(ctx, statusCode, errors.Wrapf(err, errorTemplate, vol.ID))
		}
	}
...
func (r *mutationResolver) UpdateVolume(ctx context.Context, updateVolumeInput gqlModel.UpdateVolumeInput) (bool, error) {
	...
	err = gqlUtil.ValidateVolumeExpirationInput(ctx, updateVolumeInput.Expiration, updateVolumeInput.NoExpiration)
	if err != nil {
		return false, err
	}
	err = gqlUtil.ValidateVolumeName(ctx, updateVolumeInput.Name)
	if err != nil {
		return false, err
	}
	...
	err = gqlUtil.ApplyVolumeOptions(ctx, *volume, updateOptions)
	if err != nil {
...
func (r *mutationResolver) SpawnHost(ctx context.Context, spawnHostInput *gqlModel.SpawnHostInput) (*restModel.APIHost, error) {
	...
	if spawnHostInput.SavePublicKey {
		if err := gqlUtil.SavePublicKey(ctx, *spawnHostInput.PublicKey); err != nil {
			return nil, err
		}
	}
...
func (r *mutationResolver) EditSpawnHost(ctx context.Context, editSpawnHostInput *gqlModel.EditSpawnHostInput) (*restModel.APIHost, error) {
	...
	if editSpawnHostInput.PublicKey != nil {
		if utility.FromBoolPtr(editSpawnHostInput.SavePublicKey) {
			if err = gqlUtil.SavePublicKey(ctx, *editSpawnHostInput.PublicKey); err != nil {
				return nil, err
			}
		}
...
func (r *mutationResolver) UpdateSpawnHostStatus(ctx context.Context, hostID string, action gqlModel.SpawnHostStatusActions) (*restModel.APIHost, error) {
	...
	if err != nil {
		...
		return nil, gqlUtil.MapHTTPStatusToGqlError(ctx, httpStatus, err)
	}
	apiHost := restModel.APIHost{}
	err = apiHost.BuildFromService(h)
	if err != nil {
...
func (r *queryResolver) MyVolumes(ctx context.Context) ([]*restModel.APIVolume, error) {
	...
	return gqlUtil.GetAPIVolumeList(volumes)
}
...
func (r *queryResolver) ProjectEvents(ctx context.Context, identifier string, limit *int, before *time.Time) (*gqlModel.ProjectEvents, error) {
	...
	res := &gqlModel.ProjectEvents{
		EventLogEntries: gqlUtil.GetPointerEventList(events),
		Count:           len(events),
	}
	return res, err
}
...
func (r *patchResolver) CommitQueuePosition(ctx context.Context, apiPatch *restModel.APIPatch) (*int, error) {
	...
	if *apiPatch.Alias == evergreen.CommitQueueAlias {
		...
		if err != nil {
			return nil, gqlError.InternalServerError.Send(ctx, fmt.Sprintf("Error getting commit queue position for patch %s: %s", *apiPatch.Id, err.Error()))
		}
		if cq != nil {
...
func (r *patchResolver) Duration(ctx context.Context, obj *restModel.APIPatch) (*gqlModel.PatchDuration, error) {
	...
	var tPointer *string
	if t != "0s" {
		tFormated := gqlUtil.FormatDuration(t)
		tPointer = &tFormated
	}
	m := makespan.Round(time.Second).String()
	var mPointer *string
	if m != "0s" {
		mFormated := gqlUtil.FormatDuration(m)
		mPointer = &mFormated
	}
...
func (r *patchResolver) Time(ctx context.Context, obj *restModel.APIPatch) (*gqlModel.PatchTime, error) {
	...
	started, err := gqlUtil.GetFormattedDate(obj.StartTime, usr.Settings.Timezone)
	if err != nil {
		return nil, gqlError.InternalServerError.Send(ctx, err.Error())
	}
	finished, err := gqlUtil.GetFormattedDate(obj.FinishTime, usr.Settings.Timezone)
	if err != nil {
		return nil, gqlError.InternalServerError.Send(ctx, err.Error())
	}
	submittedAt, err := gqlUtil.GetFormattedDate(obj.CreateTime, usr.Settings.Timezone)
	if err != nil {
		return nil, gqlError.InternalServerError.Send(ctx, err.Error())
	}
...
func (r *patchResolver) Project(ctx context.Context, apiPatch *restModel.APIPatch) (*gqlModel.PatchProject, error) {
	patchProject, err := gqlUtil.GetPatchProjectVariantsAndTasksForUI(ctx, apiPatch)
	if err != nil {
		return nil, err
	}
...
func (r *queryResolver) Patch(ctx context.Context, id string) (*restModel.APIPatch, error) {
	...
	if evergreen.IsFinishedPatchStatus(*patch.Status) {
		...
		statuses := gqlUtil.GetAllTaskStatuses(tasks)
...
func (r *queryResolver) Project(ctx context.Context, id string) (*restModel.APIProjectRef, error) {
	...
	if err != nil {
		return nil, gqlError.InternalServerError.Send(ctx, fmt.Sprintf("Error finding project by id %s: %s", id, err.Error()))
	}
	apiProjectRef := restModel.APIProjectRef{}
...
func (r *queryResolver) Task(ctx context.Context, taskID string, execution *int) (*restModel.APITask, error) {
	...
	apiTask, err := gqlUtil.GetAPITaskFromTask(ctx, r.sc.GetURL(), *dbTask)
	if err != nil {
...
func (r *queryResolver) TaskAllExecutions(ctx context.Context, taskID string) ([]*restModel.APITask, error) {
	...
	apiTask, err := gqlUtil.GetAPITaskFromTask(ctx, r.sc.GetURL(), *latestTask)
	if err != nil {
		return nil, gqlError.InternalServerError.Send(ctx, "error converting task")
	}
	allTasks = append(allTasks, apiTask)
...
func (r *queryResolver) Projects(ctx context.Context) ([]*gqlModel.GroupedProjects, error) {
	...
	groupedProjects, err := gqlUtil.GroupProjects(enabledProjects, false)
	if err != nil {
...
func (r *queryResolver) ViewableProjectRefs(ctx context.Context) ([]*gqlModel.GroupedProjects, error) {
	...
	groupedProjects, err := gqlUtil.GroupProjects(projects, true)
	if err != nil {
		return nil, gqlError.InternalServerError.Send(ctx, fmt.Sprintf("error grouping project: %s", err.Error()))
	}
	return groupedProjects, nil
...
func (r *queryResolver) PatchTasks(ctx context.Context, patchID string, sorts []*gqlModel.SortOrder, page *int, limit *int, statuses []string, baseStatuses []string, variant *string, taskName *string, includeEmptyActivation *bool) (*gqlModel.PatchTasks, error) {
	...
	opts := task.GetTasksByVersionOptions{
		Statuses:                       gqlUtil.GetValidTaskStatusesFilter(statuses),
		BaseStatuses:                   gqlUtil.GetValidTaskStatusesFilter(baseStatuses),
...
func (r *queryResolver) TaskTests(ctx context.Context, taskID string, execution *int, sortCategory *gqlModel.TestSortCategory,
	sortDirection *gqlModel.SortDirection, page *int, limit *int, testName *string, statuses []string, groupID *string) (*gqlModel.TaskTestResult, error) {
...
func (r *queryResolver) TaskTestSample(ctx context.Context, tasks []string, testFilters []*gqlModel.TestFilter) ([]*gqlModel.TaskTestResultSample, error) {
	...
	if dbTasks[0].HasCedarResults {
		...
		results, err := gqlUtil.GetCedarFailedTestResultsSample(ctx, dbTasks, failingTests)
		if err != nil {
...
func (r *queryResolver) TaskFiles(ctx context.Context, taskID string, execution *int) (*gqlModel.TaskFiles, error) {
	...
	if t.DisplayOnly {
		...
		for _, execTask := range execTasks {
			groupedFiles, err := gqlUtil.GetGroupedFiles(ctx, execTask.DisplayName, execTask.Id, t.Execution)
			if err != nil {
		...
		groupedFiles, err := gqlUtil.GetGroupedFiles(ctx, t.DisplayName, taskID, t.Execution)
		if err != nil {
			return &emptyTaskFiles, err
		}
		fileCount += len(groupedFiles.Files)
...
func (r *mutationResolver) SetTaskPriority(ctx context.Context, taskID string, priority int) (*restModel.APITask, error) {
	...
	apiTask, err := gqlUtil.GetAPITaskFromTask(ctx, r.sc.GetURL(), *t)
	return apiTask, err
}
...
func (r *mutationResolver) OverrideTaskDependencies(ctx context.Context, taskID string) (*restModel.APITask, error) {
	...
	return gqlUtil.GetAPITaskFromTask(ctx, r.sc.GetURL(), *t)
}
...
func (r *mutationResolver) SchedulePatch(ctx context.Context, patchID string, configure gqlModel.PatchConfigure) (*restModel.APIPatch, error) {
	patchUpdateReq := gqlUtil.BuildFromGqlInput(configure)
	...
	if err != nil {
		return nil, gqlUtil.MapHTTPStatusToGqlError(ctx, statusCode, errors.Errorf("Error scheduling patch `%s`: %s", patchID, err.Error()))
	}
...
func (r *mutationResolver) SchedulePatchTasks(ctx context.Context, patchID string) (*string, error) {
	...
	err := gqlUtil.ModifyVersionHandler(ctx, patchID, modifications)
	if err != nil {
		return nil, err
	}
	return &patchID, nil
...
func (r *mutationResolver) ScheduleUndispatchedBaseTasks(ctx context.Context, patchID string) ([]*restModel.APITask, error) {
	...
	scheduled, err := gqlUtil.SetManyTasksScheduled(ctx, r.sc.GetURL(), true, taskIDs...)
	if err != nil {
		return nil, err
	}
...
func (r *mutationResolver) UnscheduleTask(ctx context.Context, taskID string) (*restModel.APITask, error) {
	scheduled, err := gqlUtil.SetManyTasksScheduled(ctx, r.sc.GetURL(), false, taskID)
	if err != nil {
		return nil, err
	}
	if len(scheduled) == 0 {
...
func (r *mutationResolver) ClearMySubscriptions(ctx context.Context) (int, error) {
	...
	subIDs := gqlUtil.RemoveGeneralSubscriptions(usr, subs)
...
func (r *mutationResolver) SaveSubscription(ctx context.Context, subscription restModel.APISubscription) (bool, error) {
	usr := gqlUtil.MustHaveUser(ctx)
	username := usr.Username()
	idType, id, err := gqlUtil.GetResourceTypeAndIdFromSubscriptionSelectors(ctx, subscription.Selectors)
	if err != nil {
		return false, err
	}
	switch idType {
...
func (r *mutationResolver) RestartJasper(ctx context.Context, hostIds []string) (int, error) {
	...
	if err != nil {
		return 0, gqlUtil.MapHTTPStatusToGqlError(ctx, httpStatus, err)
	}
	...
	if err != nil {
		return 0, gqlUtil.MapHTTPStatusToGqlError(ctx, httpStatus, errors.Errorf("Error marking selected hosts as needing Jasper service restarted: %s", err.Error()))
	}
...
func (r *mutationResolver) ReprovisionToNew(ctx context.Context, hostIds []string) (int, error) {
	...
	if err != nil {
		return 0, gqlUtil.MapHTTPStatusToGqlError(ctx, httpStatus, errors.Errorf("Error marking selected hosts as needing to reprovision: %s", err.Error()))
	}
...
func (r *mutationResolver) CreatePublicKey(ctx context.Context, publicKeyInput gqlModel.PublicKeyInput) ([]*restModel.APIPubKey, error) {
	err := gqlUtil.SavePublicKey(ctx, publicKeyInput)
	if err != nil {
		return nil, err
	}
	myPublicKeys := gqlUtil.GetMyPublicKeys(ctx)
...
func (r *mutationResolver) RemovePublicKey(ctx context.Context, keyName string) ([]*restModel.APIPubKey, error) {
	if !gqlUtil.DoesPublicKeyNameAlreadyExist(ctx, keyName) {
	...
	err := gqlUtil.MustHaveUser(ctx).DeletePublicKey(keyName)
	if err != nil {
...
func (r *mutationResolver) UpdatePublicKey(ctx context.Context, targetKeyName string, updateInfo gqlModel.PublicKeyInput) ([]*restModel.APIPubKey, error) {
	if !gqlUtil.DoesPublicKeyNameAlreadyExist(ctx, targetKeyName) {
	...
	if updateInfo.Name != targetKeyName && gqlUtil.DoesPublicKeyNameAlreadyExist(ctx, updateInfo.Name) {
	...
	err := gqlUtil.VerifyPublicKey(ctx, updateInfo)
	if err != nil {
		return nil, err
	}
	usr := gqlUtil.MustHaveUser(ctx)
...
func (r *taskResolver) SpawnHostLink(ctx context.Context, at *restModel.APITask) (*string, error) {
	...
	if err != nil {
		return nil, gqlError.InternalServerError.Send(ctx, fmt.Sprintf("error finding host for task %s", *at.Id))
	}
	if host == nil {
		return nil, nil
	}
...
func (r *taskResolver) CanRestart(ctx context.Context, obj *restModel.APITask) (bool, error) {
	...
	return gqlUtil.CanRestartTask(t), nil
}
...
func (r *taskResolver) CanSchedule(ctx context.Context, obj *restModel.APITask) (bool, error) {
	...
	return gqlUtil.CanScheduleTask(t), nil
}
...
func (r *queryResolver) BuildBaron(ctx context.Context, taskID string, exec int) (*gqlModel.BuildBaron, error) {
...
func (r *mutationResolver) BbCreateTicket(ctx context.Context, taskID string, execution *int) (bool, error) {
	...
	if err != nil {
		return false, gqlUtil.MapHTTPStatusToGqlError(ctx, httpStatus, err)
	}
...
func (r *queryResolver) BbGetCreatedTickets(ctx context.Context, taskID string) ([]*thirdparty.JiraTicket, error) {
	createdTickets, err := gqlUtil.BBGetCreatedTicketsPointers(taskID)
	if err != nil {
		return nil, err
	}
...
func (r *queryResolver) MainlineCommits(ctx context.Context, options gqlModel.MainlineCommitsOptions, buildVariantOptions *gqlModel.BuildVariantOptions) (*gqlModel.MainlineCommits, error) {
	...
	for matchingVersionCount < limit {
		...
		if v.Activated == nil {
			err = gqlUtil.SetVersionActivationStatus(&v)
			if err != nil {
		...
		if !utility.FromBoolPtr(v.Activated) {
			shouldCollapse = true
		} else if gqlUtil.IsPopulated(buildVariantOptions) && utility.FromBoolPtr(options.ShouldCollapse) {
			opts := task.HasMatchingTasksOptions{
				TaskNames: buildVariantOptions.Tasks,
				Variants:  buildVariantOptions.Variants,
				Statuses:  gqlUtil.GetValidTaskStatusesFilter(buildVariantOptions.Statuses),
			}
...
func (r *versionResolver) Manifest(ctx context.Context, v *restModel.APIVersion) (*gqlModel.Manifest, error) {
	m, err := manifest.FindFromVersion(*v.Id, *v.Project, *v.Revision, *v.Requester)
	if err != nil {
		return nil, gqlError.InternalServerError.Send(ctx, fmt.Sprintf("Error fetching manifest for version %s : %s", *v.Id, err.Error()))
	}
	if m == nil {
		return nil, nil
	}
...
func (r *versionResolver) TaskStatusCounts(ctx context.Context, v *restModel.APIVersion, options *gqlModel.BuildVariantOptions) ([]*task.StatusCount, error) {
	opts := task.GetTasksByVersionOptions{
		IncludeBaseTasks:      false,
		IncludeExecutionTasks: false,
		TaskNames:             options.Tasks,
		Variants:              options.Variants,
		Statuses:              gqlUtil.GetValidTaskStatusesFilter(options.Statuses),
	}
...
func (r *versionResolver) TaskStatusStats(ctx context.Context, v *restModel.APIVersion, options *gqlModel.BuildVariantOptions) (*task.TaskStats, error) {
	opts := task.GetTasksByVersionOptions{
		IncludeBaseTasks:      false,
		IncludeExecutionTasks: false,
		TaskNames:             options.Tasks,
...
func (r *versionResolver) BuildVariants(ctx context.Context, v *restModel.APIVersion, options *gqlModel.BuildVariantOptions) ([]*gqlModel.GroupedBuildVariant, error) {
	...
	if v.Activated == nil {
		...
		if err != nil {
			return nil, gqlError.InternalServerError.Send(ctx, fmt.Sprintf("Error fetching version: %s : %s", *v.Id, err.Error()))
		}
		if err = gqlUtil.SetVersionActivationStatus(version); err != nil {
			return nil, gqlError.InternalServerError.Send(ctx, fmt.Sprintf("Error setting version activation status: %s", err.Error()))
		}
	...
	groupedBuildVariants, err := gqlUtil.GenerateBuildVariants(utility.FromStringPtr(v.Id), *options)
	if err != nil {
		return nil, gqlError.InternalServerError.Send(ctx, fmt.Sprintf("Error generating build variants for version %s : %s", *v.Id, err.Error()))
	}
	return groupedBuildVariants, nil
}

func (r *versionResolver) BuildVariantStats(ctx context.Context, v *restModel.APIVersion, options *gqlModel.BuildVariantOptions) ([]*task.GroupedTaskStatusCount, error) {
	opts := task.GetTasksByVersionOptions{
		TaskNames:                      options.Tasks,
		Variants:                       options.Variants,
...
func (r *versionResolver) Patch(ctx context.Context, v *restModel.APIVersion) (*restModel.APIPatch, error) {
	...
	if err != nil {
		return nil, gqlError.InternalServerError.Send(ctx, fmt.Sprintf("Couldn't find a patch with id: `%s` %s", *v.Id, err.Error()))
	}
	return apiPatch, nil
}
...
func (r *versionResolver) Status(ctx context.Context, obj *restModel.APIVersion) (string, error) {
	collectiveStatusArray, err := gqlUtil.GetCollectiveStatusArray(*obj)
	if err != nil {
...
func (*versionResolver) UpstreamProject(ctx context.Context, obj *restModel.APIVersion) (*gqlModel.UpstreamProject, error) {
...
func New(apiURL string) generated.Config {
	...
	c.Directives.RequireProjectAccess = func(ctx context.Context, obj interface{}, next graphql.Resolver, access gqlModel.ProjectSettingsAccess) (res interface{}, err error) {
		...
		if id, hasId := args["id"].(string); hasId {
			return gqlUtil.HasProjectPermission(ctx, id, next, permissionLevel)
		} else if projectId, hasProjectId := args["projectId"].(string); hasProjectId {
			return gqlUtil.HasProjectPermission(ctx, projectId, next, permissionLevel)
			...
			return gqlUtil.HasProjectPermission(ctx, pid, next, permissionLevel)
		}
